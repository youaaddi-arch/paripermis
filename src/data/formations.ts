...
const formationsData: Formation[] = [
  ...
  },
  {
    ...
    programme: [
      "Accueil, présentation de la formation et évaluation de départ",
      "Réglementation et sécurité spécifiques à l'ensemble articulé : masses et dimensions, répartition des charges, documents de bord",
      "Connaissance de l'ensemble (tracteur et semi-remorque) : vérifications courantes de sécurité et interrogation orale (fiches)",
      "Attelage et dételage de la remorque ou semi-remorque en sécurité",
      "Maniabilité hors circulation (plateau) : manœuvres en marche arrière et placements de précision de l'ensemble",
      "Conduite en circulation en fonction du gabarit ; conditions difficiles, éco-conduite et partage de la route",
      "Préparation aux épreuves (hors circulation et en circulation) et examen blanc",
    ],
    methodes: ["Formation en présentiel", "Méthodes pédagogiques multiples : actives, participatives et didactiques"],
    moyens: [
  ...
  // ---------------------- VOYAGEURS ----------------------
  {
    ...
    programme: [
      "Accueil, présentation de la formation et évaluation de départ",
      "Réglementation et sécurité du transport en commun : gabarit, accessibilité PMR, documents de bord",
      "Connaissance du véhicule : organes de sécurité, vérifications courantes et interrogation orale (fiches)",
      "Maniabilité hors circulation (plateau) : prise en main de l'autobus/autocar, manœuvres et accostage aux arrêts",
      "Conduite en circulation : confort et sécurité des passagers en agglomération, route et voie rapide",
      "Conduite en conditions difficiles, éco-conduite et partage de la route avec les autres usagers",
      "Préparation aux épreuves (hors circulation et en circulation) et examen blanc",
    ],
